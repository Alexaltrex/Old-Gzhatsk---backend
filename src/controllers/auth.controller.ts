...
import {userDB} from "../db/auth/UserDB";
import {authService, LoginReturnData} from "../services/auth.service";
...
export const authController = {
    ...
    //============== CHANGE PASSWORD ==================
    changePassword: async (req: Request & {userId: string}, res: Response, next: NextFunction) => {
        try {
    ...
    //============== GET USER INFO ==================
    getUserInfo: async (req: Request & {userId: string}, res: Response, next: NextFunction) => {
        try {
            const userId = req.userId;
    ...
    //============== CHANGE NICKNAME ==================
    changeNickname: async (req: Request & {userId: string}, res: Response, next: NextFunction) => {
        try {
            const userId = req.userId;
    ...
    //============== CHANGE AVATAR ==================
    changeAvatar: async (req: Request & {userId: string, file: Express.Multer.File}, res: Response, next: NextFunction) => {
        try {
            const userId = req.userId;
            const file = req.file;
